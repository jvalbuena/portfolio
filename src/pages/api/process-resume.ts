...
const client = createClient({
  projectId: process.env.SANITY_PROJECT_ID || 'your_project_id', // Replace with your Sanity project ID
  dataset: process.env.SANITY_DATASET || 'your_dataset', // Replace with your Sanity dataset
